        ...
        <div className="flex min-h-screen bg-white dark:bg-slate-950 font-sans selection:bg-accent selection:text-white">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 overflow-y-auto relative">
                {onBack && (
                    <button 
                        onClick={onBack}
                        className="absolute top-6 left-6 sm:top-12 sm:left-12 text-sm font-medium text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-white flex items-center gap-2 transition-colors"
                    >
                        &larr; Back to Home
                    </button>
                )}
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-none sm:shadow-lg sm:border border-slate-200 dark:border-slate-800 p-0 sm:p-10">
                        ...
                        {authView === 'login' && (
                            <form onSubmit={handleLoginSubmit} className="space-y-5">
                                ...
                                <Button type="button" variant="secondary" className="w-full flex items-center justify-center gap-3 py-2.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 hover:bg-slate-50" onClick={handleGoogleLogin}>
